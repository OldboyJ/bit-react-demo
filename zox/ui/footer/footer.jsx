...
export function Footer() {
  const iconDetails = footerData["contact"].svgIcon.map((icon) => {
    return (
      <li>
        <a href={icon.hrefLink}>
          <span>
  ...
  const linkKeys = Object.keys(footerData)
  const footerLinks = linkKeys.map((title) => {
    return (
      <div className={styles["section-links"]}>
        <p>{footerData[title].name}</p>
        {title !== "contact" ? (
          <ul>
            {footerData[title].items.map((item) => {
              return (
                <li>
          ...
          <div className={styles["contact-column"]}>
            <span>
              <p>{footerData[title].address.street}</p>
              <p>{footerData[title].address.city_zip}</p>
              <ul className={styles["social-icons"]}>{iconDetails}</ul>
            </span>
          </div>
        )}
      </div>
  ...
  return (
    <>
      <section className={styles["footer-links"]}>{footerLinks}</section>
      <section className={styles["payment-options"]}>
        <div className={styles["zox-rights"]}>
          <span>
            © 2021{" "}
            <a href="/" title="">
              ZOX
